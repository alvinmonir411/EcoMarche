        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <main className="flex-1">
            <header className="mb-12">
              ...
              <h1 className="text-4xl font-bold text-secondary mb-2">Create Category</h1>
            ...
            <div className="max-w-2xl bg-white p-10 rounded-[32px] shadow-sm border border-accent/20">
              <form className="space-y-8">
                <Input label="Category Name" placeholder="e.g. Winter Wear" />
                <Input label="Slug" placeholder="e.g. winter-wear" />
                ...
                <div className="flex justify-end gap-6 pt-4">
                  ...
                  <Button size="lg" className="px-10 shadow-lg shadow-primary/20">Save Category</Button>
                </div>
              </form>
            </div>
          </main>
