...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Stock', href: '/admin/stock', icon: 'M9 17v-2a4 4 0 014-4h7M9 7h11M5 7h.01M5 12h.01M5 17h.01M9 12h3' },
    ...
    { name: 'Subcategories', href: '/admin/subcategories', icon: 'M4 6h16M4 12h10M4 18h7' },
    { name: 'Brands', href: '/admin/brands', icon: 'M12 3l2.2 4.46 4.92.72-3.56 3.47.84 4.9L12 14.24 7.6 16.55l.84-4.9-3.56-3.47 4.92-.72L12 3z' },
    { name: 'Orders', href: '/admin/orders', icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z' },
    { name: 'Sections', href: '/admin/sections', icon: 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2zM4 21a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2z' },
      ...
      <div className="bg-white rounded-[32px] shadow-sm border border-accent/20 overflow-hidden sticky top-28">
        <div className="p-8 bg-secondary text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[10px] uppercase tracking-widest text-gray-400 font-bold">EcoMarche Store</p>
          </div>
        </div>
